...
public class SettingsDialog extends JDialog {
	...
	public SettingsDialog() {
		...
		{
			JCheckBox chckbxProxyAuth = new JCheckBox("Proxy Auth");
			chckbxProxyAuth.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					txtUsername.setEnabled(chckbxProxyAuth.isSelected());
				}
			});
			GridBagConstraints gbc_chckbxProxyAuth = new GridBagConstraints();
			gbc_chckbxProxyAuth.insets = new Insets(0, 0, 5, 5);
			gbc_chckbxProxyAuth.gridx = 0;
			gbc_chckbxProxyAuth.gridy = 4;
			contentPanel.add(chckbxProxyAuth, gbc_chckbxProxyAuth);
		}
		{
